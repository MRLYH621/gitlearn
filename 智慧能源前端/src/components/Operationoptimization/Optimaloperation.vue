        ...
        <div id="crumbs" style="width: 100%;height: 40px;line-height: 40ppx;padding:5px 20px">
            ...
            <div class="ensemble">
                ...
                <div class="flex_right">
                        <router-link to="/Sensitivityanalysis">敏感性分析</router-link>
...
<style scoped>
        ...
        .flex_right>a{
                width: 200px;height: 40px;line-height: 40px;color: #fff;background: #3366CC;border-radius: 5px;display: block;text-align: center;font-size: 16px;margin: 20px auto
        }
        ...
        .flex_left_C>div input{
                width: 150px;height: 30px;line-height: 30px;border-radius: 5px;
        }
</style>