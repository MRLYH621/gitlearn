 ...
 export default {
        ...
        methods: {
                save:function(){   //保存配置
                        ...
                        var url = this.$api+'Oper/AddOSE';
                        var oldThis = this;
                        if(this.value4 ==''){
                                alert("请选择能源类型！");
                                return;
                        }
                        params.append('OSE_Type',this.value4);
                        ...
                        params.append('OSE_Date',d);     
                        params.append('OSE_Parm_001',this.m1);
                        params.append('OSE_Parm_002',this.m2);
                        params.append('OSE_Parm_003',this.m3);
                        params.append('OSE_Parm_004',this.m4);
                        params.append('OSE_Parm_005',this.m5);
                        params.append('OSE_Parm_006',this.m6);
                        params.append('OSE_Parm_007',this.m7);
                        params.append('OSE_Parm_008',this.m8);
                        params.append('OSE_Parm_009',this.m9);
                        params.append('OSE_Parm_010',this.m10);
                        params.append('OSE_Parm_011',this.m11);
                        params.append('OSE_Parm_012',this.m12);
                        params.append('OSE_Parm_013',this.m13);
                        params.append('OSE_Parm_014',this.m14);
                        params.append('OSE_Parm_015',this.m15);
                        params.append('OSE_Parm_016',this.m16);
                        params.append('OSE_Parm_017',this.m17);
                        params.append('OSE_Parm_018',this.m18);
                        params.append('OSE_Parm_019',this.m19);
                        params.append('OSE_Parm_020',this.m20);
                        params.append('OSE_Parm_021',this.m21);
                        params.append('OSE_Parm_022',this.m22);
                        params.append('OSE_Parm_023',this.m23);
                        params.append('OSE_Parm_024',this.m24);
                ...
                getData(){
                        var url = this.$api+'Oper/GetOSEDate';
                        var oldThis = this;
