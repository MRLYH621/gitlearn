 ...
 export default {
        ...
        methods: {
                save:function(){   //保存配置
                        ...
                        var url = this.$api+'Oper/AddSupplyEnergy';                        
                        var oldThis = this;
                        if(this.value4 ==''){
                                alert("请选择能源类型！");
                                return;
                        }
                        params.append('SE_Type',this.value4);
                        ...
                        params.append('SE_Date',d);     
                        params.append('SE_Parm_001',this.m1);
                        params.append('SE_Parm_002',this.m2);
                        params.append('SE_Parm_003',this.m3);
                        params.append('SE_Parm_004',this.m4);
                        params.append('SE_Parm_005',this.m5);
                        params.append('SE_Parm_006',this.m6);
                        params.append('SE_Parm_007',this.m7);
                        params.append('SE_Parm_008',this.m8);
                        params.append('SE_Parm_009',this.m9);
                        params.append('SE_Parm_010',this.m10);
                        params.append('SE_Parm_011',this.m11);
                        params.append('SE_Parm_012',this.m12);
                        params.append('SE_Parm_013',this.m13);
                        params.append('SE_Parm_014',this.m14);
                        params.append('SE_Parm_015',this.m15);
                        params.append('SE_Parm_016',this.m16);
                        params.append('SE_Parm_017',this.m17);
                        params.append('SE_Parm_018',this.m18);
                        params.append('SE_Parm_019',this.m19);
                        params.append('SE_Parm_020',this.m20);
                        params.append('SE_Parm_021',this.m21);
                        params.append('SE_Parm_022',this.m22);
                        params.append('SE_Parm_023',this.m23);
                        params.append('SE_Parm_024',this.m24);
                ...
                getData(){
                        var url = this.$api+'Oper/GetSEDate';
                        var oldThis = this;
