                                                ...
                                                <el-form :label-position="labelPosition" label-width="100px" :model="model">
                                                        ...
                                                        <el-form-item label="时域：">
                                                                <el-select v-model="PID" placeholder="请选择">
                                                                        <el-option v-for="item in TOfPriceModels" :key="item.ID" :label="item.P_Name" :value="item.ID">
                                                                        </el-option>
                                                                </el-select>
                                                        </el-form-item>
...
export default {
        ...
        methods: {
                ...
                getTOfPriceData(){
                        ...
                        var oldThis = this;
                        this.$axios.get(url).then(function (response) {
                                oldThis.TOfPriceModels=[];
                                oldThis.TOfPriceModels=response.data;
                        }).catch(function (error) {
                        　　    alert(error);
                        });
